<template>
  <div>
    <Toubu :titles="name1"></Toubu>
    <div class="main" v-for="(item, index) in fangyuanList" :key="index">
      <div class="left">
...
export default {
  ...
  methods: {
    async getfangyuan () {
      ...
      try {
        const res = await getfangyuan()
        console.log(res.data.body)
        this.fangyuanList = res.data.body
      } catch (error) {}
    }
  }
}
